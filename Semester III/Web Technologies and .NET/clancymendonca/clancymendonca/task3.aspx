<%@ Page Title="Task 3" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeBehind="task3.aspx.cs" Inherits="clancymendonca.Task3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main class="task3-page-content">
        <section class="main-heading-section" style="text-align:center; margin-top:60px; padding:40px 0;">
            <h1 style="color:#F7B801; font-size:2.5em; margin-bottom:32px;">Leap Year Calculator</h1>
            <span style="display:inline-flex; align-items:center; gap:32px;">
                <asp:Label ID="lblPrompt" runat="server" Text="Enter a year:" style="font-size:1.2em;" />
                <asp:TextBox ID="txtYear" runat="server" style="font-size:1.2em; width:140px; padding:10px; border-radius:7px; border:1px solid #ccc;" />
