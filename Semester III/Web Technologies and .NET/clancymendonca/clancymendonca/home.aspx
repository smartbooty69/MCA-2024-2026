<%@ Page Title="Home" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="clancymendonca.Home" %>
            ...
            <div class="hero-content" data-aos="fade-up">
                <div class="hero-left">
                    ...
                    <div class="social-links">
                        <a href="https://www.linkedin.com/in/clancymendonca" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
                        <a href="https://github.com/smartbooty69" aria-label="GitHub"><i class="fab fa-github"></i></a>
                    </div>
                </div>
                <div class="hero-right">
                    ...
                    <div class="cta-buttons">
                        <asp:LinkButton runat="server" ID="lnkTask1" CssClass="btn" OnClick="lnkTask1_Click">Task-1</asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkTask2" CssClass="btn" OnClick="lnkTask2_Click">Task-2</asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkTask3" CssClass="btn" OnClick="lnkTask3_Click">Task-3</asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkTask4" CssClass="btn" OnClick="lnkTask4_Click">Task-4</asp:LinkButton>
                    </div>
                </div>
            </div>
        </main>
